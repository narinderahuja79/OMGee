...
<div id="content-container">	
    ...
    <div id="page-content">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="panel panel-bordered panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo "OMGee Total sales volume (quantity) per country";?></h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <p class="h4">
		...
		?>
        <div class="row"  style="display: none;" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') !== 'ok' && $this->crud_model->get_type_name_by_id('general_settings','69','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-12 col-lg-12">
                <div class="panel panel-bordered panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('24_hours_sale');?></h3>
        ...
        <div class="row" style="display: none;" <?php if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-4 col-lg-4">
        ...
        <div class="row" style="display: none;" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-bordered panel-purple">
