    ...
    <div class="col-md-12">
        ...
        <div class="tab-base horizontal-tab">
            ...
            <div class="tab-content">
                <div id="tabb-1" class="tab-pane fade" style="display:none;">
                    <div class="row">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>  
                                                            <div class="inner-div">
                                                                <img class="img-responsive img_show img-banner"  src="<?php echo base_url(); ?>uploads/banner_image/<?php echo $banner_row; ?>"  >
                                                            </div>
                                                        <?php 
                                                                }
                                                            } 
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <span class="btn btn-default btn-file">
                                                            ...
                                                            <input type="file" name="banner_images" onchange="previewbannerImg(this);" id="demo-hor-inputpass" class="form-control" accept="image">
                                                           
                                                            <input type="hidden"  name="banner_last_images" value="<?php echo $row['banner_image']; ?>" id="demo-hor-inputpass" class="form-control" accept="image">
                                                        </span>    
                ...
                <div id="tabb-3" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                ...
                <div id="tabb-4" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                ...
                <div id="tabb-5" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                ...
                <div id="tabb-6" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <div class="form-group">
                ...
                <?php
                    if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){
                ?>
                <div id="tabb-7" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12">
                        <?php
                ...
                ?>
                <div id="tabb-8" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                ...
                <div id="tabb-11" class="tab-pane fade" style="display:none;">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
    ...
    window.previewbannerImg = function (input) {
        if (input.files && input.files[0]) {
            ...
            $(input.files).each(function () {
                ...
                reader.onload = function (e) {
                    $("#previewbannerImg").append("<div style='float:left;border:4px solid #303641;padding:5px;margin:5px;'><img height='20' src='" + e.target.result + "'></div>");
                }
            });
        }
    }
