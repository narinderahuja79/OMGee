        ...
        <div class="text-center pad-all">
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('added_by');?></th>
                        <td class="custom_td">
                            <?php echo  $res['added_by']  = $this->crud_model->product_by($row['product_id']);?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="custom_td"><?php echo $row['bundle_sale1']; ?> / <?php echo $row['unit']; ?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('Wholesale');?></th>
