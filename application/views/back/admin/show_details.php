        ...
        <div class="text-center pad-all">
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo 'Start Date';?></th>
                        <td class="custom_td">
                            <!-- <?php echo $row['start_date']  ?> -->
                            <?php echo date_format(date_create($row['start_date']),"d M,Y h:i:s"); ?>
                        </td>
                    </tr>
                   <tr>
                        <th class="custom_td"><?php echo 'End Date' ?></th>
                        <td class="custom_td">
                        	<?php echo date_format(date_create($row['end_date']),"d M,Y h:i:s"); ?>
                        </td>
                    </tr>
                    <!--  <tr>
