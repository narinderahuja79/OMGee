<?php 
    ...
    $aud_tax  = $this->db->get_where('business_settings', array(
        'type' => 'aud_tax'
    ))->row()->value;
    $hkd_tax  = $this->db->get_where('business_settings', array(
        'type' => 'hkd_tax'
    ))->row()->value;
    $jpy_tax  = $this->db->get_where('business_settings', array(
        'type' => 'jpy_tax'
    ))->row()->value;
    $sgd_tax  = $this->db->get_where('business_settings', array(
        'type' => 'sgd_tax'
    ))->row()->value;
    	...
    	<div class="col-md-12">
            <div class="col-md-12">
            	...
            	<div class="panel panel-bordered panel-dark">
                    <div class="panel-heading">
                        <center>
                            <h3 class="panel-title"><?php echo translate('tax')?></h3>
                        </center>
                    </div>
                    <div class="panel-body">  
						<?php
                            echo form_open(base_url() . 'admin/set_def_curr/aud_tax', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'enctype' => 'multipart/form-data'
                            ));
                        ?>                                  
                            <div class="form-group">
                            	<label class="col-sm-3 control-label"><?php echo "AUD Tax (%)";?></label>
                                <div class="col-sm-6">                              
                                    <input type="number" name="aud_tax" min="1" max="10000" class="form-control required" value="<?php echo $aud_tax; ?>">
                                </div>
                                <div class="col-sm-3">  
                                	<span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left saver" data-ing="<?php echo translate('saving'); ?>.."><?php echo translate('save');?></span>
                                </div>
                        ...
                        <?php
                            echo form_open(base_url() . 'admin/set_def_curr/hkd_tax', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'enctype' => 'multipart/form-data'
                            ));
                        ?>                                  
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo "HKD Tax (%)";?></label>
                                <div class="col-sm-6">                              
                                    <input type="number" name="hkd_tax" min="1" max="10000" class="form-control required" value="<?php echo $hkd_tax; ?>">
                                </div>
                                <div class="col-sm-3">  
                                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left saver" data-ing="<?php echo translate('saving'); ?>.."><?php echo translate('save');?></span>
                                </div>
                        ...
                        <?php 
                            echo form_open(base_url() . 'admin/set_def_curr/jpy_tax', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'enctype' => 'multipart/form-data'
                            ));
                        ?>                                  
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo "JPY Tax (%)";?></label>
                                <div class="col-sm-6">                              
                                    <input type="number" name="jpy_tax" min="1" max="10000" class="form-control required" value="<?php echo $jpy_tax; ?>">
                                </div>
                                <div class="col-sm-3">  
                                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left saver" data-ing="<?php echo translate('saving'); ?>.."><?php echo translate('save');?></span>
                                </div>
                        ...
                        <?php
                               echo form_open(base_url() . 'admin/set_def_curr/sgd_tax', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'enctype' => 'multipart/form-data'
                            ));
                        ?>                                  
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo "SGD Tax (%)";?></label>
                                <div class="col-sm-6">                              
                                    <input type="number" name="sgd_tax" min="1" max="10000" class="form-control required" value="<?php echo $sgd_tax; ?>">
                                </div>
                                <div class="col-sm-3">  
                                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-left saver" data-ing="<?php echo translate('saving'); ?>.."><?php echo translate('save');?></span>
                                </div>
