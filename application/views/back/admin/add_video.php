...
<div class="row">
    <div class="col-md-12">
    <?php
            echo form_open(base_url() . 'admin/add_video/do_add_vid/', array(
                    ...
                    <div class="tab-content">
                      <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo 'Add Videos'; ?></h4>
                            </div>

                            

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="video_title"><?php echo translate('product_title');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="video_title" placeholder="<?php echo translate('product_title');?>" class="form-control required">
                                </div>
                            </div>                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="video_logo"><?php echo translate('add_logo');?></label>
                                <div class="col-sm-6">
                                  ...
                                  <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_logo');?>
                                    <input type="file" name="logo" id="video_logo" class="form-control imgInp">
                                  </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-13"><?php echo 'Description'; ?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="sdate"><?php echo 'Start date';?></label>
                                <div class="col-sm-2">
                                    <input type="date" name="sdate" id="sdate" class="form-control">
                                </div>
                                 <label class="col-sm-2 control-label" for="stime"><?php echo 'Start Time';?></label>
                                <div class="col-sm-2">
                            ...
                            <!--  <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="stime"><?php echo 'Start Time';?></label>
                                <div class="col-sm-6">
                                    <input type="time" name="stime" id="sdate" class="form-control">
                                </div>
                            </div> -->


                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo 'End date';?></label>
                                <div class="col-sm-2">
                                    <input type="date" name="edate" id="edate" class="form-control">
                                </div>
                                <label class="col-sm-2 control-label" for="etime"><?php echo 'End Time';?></label>
                                <div class="col-sm-2">
            ...
            <div class="panel-footer">
                <div class="row">
                  <div class="col-md-11">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('add_video','<?php echo 'Content has been uploaded!'; ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
