<?php				
	...
	foreach($promocode_data as $row){
?>
    <div>
        <?php
			echo form_open(base_url() . 'admin/promocode/update/' . $row['promocode_id'], array(
		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input readonly type="text" name="code" id="demo-hor-1"  value="<?php echo $row['code']; ?>"
