                                        ...
                                        <table class="table" border="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $info['state_or_province_code']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('phone');?></b></td>
                                                    <td><?php echo $info['phone']; ?></td>
	...
	function MapApiLoaded() {
		...
		function initialize() {
		  ...
		  var infowindow = new google.maps.InfoWindow({
			content: '<p><?php echo translate('marker_location'); ?>:</p><p><?php echo $info['address1']; ?> </p><p><?php echo $info['address2']; ?> </p><p><?php echo translate('city'); ?>: <?php echo $info['city']; ?> </p><p><?php echo translate('state_or_province_code'); ?>: <?php echo $info['state_or_province_code']; ?> </p>'
		  });
