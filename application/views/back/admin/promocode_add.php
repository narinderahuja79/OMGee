...
<div>
	<?php
        echo form_open(base_url() . 'admin/promocode/do_add/', array(
    ...
    ?>
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('promocode_title');?></label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="date" name="till" id="demo-hor-1" class="form-control required">
                </div>
            </div>
            
            <div class="form-group" style="display: none;">
                <label class="col-sm-4 control-label"><?php echo translate('promocode_discount_on');?></label>
                <div class="col-sm-6">
                    <?php
                        $cashback_product = $this->db->get_where('promocode')->result_array();
                    ...
                    ?>
                    <select data-placeholder="<?php echo translate('choose_product');?>" name='product[]' class="demo-cs-tenselect" multiple tabindex="2">
                        <?php
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('promocode_code');?></label>
                <div class="col-sm-6">
                    <input readonly type="text" name="code" id="demo-hor-1" value="<?php echo $code; ?>"
