    ...
    <div>
		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('button_text1');?></label>
                        <div class="col-sm-6">
                            <input type="text" name="button_text1" id="demo-hor-3" value="<?php echo $row['button_text1'];?>"
                                placeholder="<?php echo translate('button_text1'); ?>" class="form-control"><br>
                        </div>
                        <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('button_text2');?></label>
                        <div class="col-sm-6">        
                            <input type="text" name="button_text2" id="demo-hor-3" value="<?php echo $row['button_text2'];?>"
                                placeholder="<?php echo translate('button_text2'); ?>" class="form-control"><br>
                        </div>
                        <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('button_text3');?></label>
                        <div class="col-sm-6">        
                            <input type="text" name="button_text3" id="demo-hor-3" value="<?php echo $row['button_text3'];?>"
                                placeholder="<?php echo translate('button_text3'); ?>" class="form-control"><br>        
                        </div>
                </div>
                <div class="form-group">
