<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate('Removed_product');?></h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                <div class="panel-body">
                    <div class="tab-content" >
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            ...
                            <button style="display: none;" class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                            ...
                            <button style="display: none;" class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
