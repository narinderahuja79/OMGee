<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'vendor/product_bundle/do_add/', array(
...
<script>
    ...
    function get_cat(id,now){
        ...
        $('#brn'+co).hide('slow');
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'vendor/product_bundle/sub_by_cat/'+id,'sub_cat'+co,'other');
        $('#sub'+co).show('slow');
    }
	function get_brnd(id,now){
        ...
        $('#brn'+co).hide('slow');
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'vendor/product_bundle/brand_by_sub/'+id,'brand'+co,'other');
        $('#brn'+co).show('slow');
    }
    function get_prod(id,now){
        ...
        $('#prod'+co).hide('slow');
        ajax_load(base_url+'vendor/product_bundle/prod_by_brand/'+id+'/'+sub_cat+'/'+cat,'product'+co,'other');
        $('#prod'+co).show('slow');
    }
