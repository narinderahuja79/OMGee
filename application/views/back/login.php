...
<head>
	...
	<style type="text/css">
		/*custom css 5 oct login form */
.loginblock_Desi{
        color: #fff !important;
    box-shadow: 0px 2px 4px #777777 !important;
    border-bottom: 1px solid #0c26a0 !important;
    background-image: linear-gradient(to right, #050f40 13%, #0c174d 51%, #050f40 100%) !important;

}
.loginblock_Desi .btn-login{
    background-color: #f1d771;
    border-color: #e5c65e;
    color: #0c174d;
    transition: all .4s ease-in-out;
}
.loginblock_Desi .btn-login:hover, .btn-login:focus, .btn-login:active, .btn-login.active, .open>.dropdown-toggle.btn-login {
	background-color: #ffffff;
}
.loginblock_Desi .input-group-addon:hover {
...
<body>
    ...
    style="background:url(<?php echo base_url(); ?>uploads/others/repeat.jpg) 50% 50% / auto repeat scroll;">
		...
		<div class="cls-content">
			<div class="loginblock_Desi cls-content-sm panel panel-colorful panel-login" style="margin-top: 50px !important;">
