<?php
	$product_type = (($cur_category == 'todays_deal')||($cur_category == 'latest')) ? $cur_category : '';  
...
<script>
    ...
    function do_product_search(page){
        ...
        $('#sub_categoryaa').val("<?php echo $cur_sub_category; ?>");
        $('#search_text').val("<?php echo $text; ?>");
        $('#vendoraa').val($('.set_vendor').find('.vendor_search').val());
        $('#brandaa').val("<?php echo $cur_brand; ?>");
