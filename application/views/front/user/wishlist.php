		...
		$('.quantity-field'+productid).val(value);
                    ...
                    $checkcount = count(json_decode($row1['products']));
                            ...
                            {       
                                    ...
                                    $gap_revenue1 = $rrp - $wholesale;
                                    $gap_revenue_commission1 = $gap_revenue1 * $commission_amount;	
                                    $orp1 = $rrp - (($gap_revenue1 - $gap_revenue_commission1)*$orp_commission_amount);
                                    $total_discount1 = $orp1 * $discount;
                                    $total_orp1 = $orp1 - $total_discount1;
                                    $lat_sale_price1 =$total_orp1*1;

                                    $gap_revenue2 = $rrp - $wholesale;
                                    $gap_revenue_commission2 = $gap_revenue2 * $commission_amount;	
                                    $orp2 = $rrp - (($gap_revenue2 - $gap_revenue_commission2)*$orp_commission_amount);
                                    $total_discount2 = $orp2 * $discount;
                                    $total_orp2 = $orp2 - $total_discount2;
                                    $lat_sale_price2 =$total_orp2*6;

                                    $gap_revenue3 = $rrp - $wholesale;
                                    $gap_revenue_commission3 = $gap_revenue3 * $commission_amount;	
                                    $orp3 = $rrp - (($gap_revenue3 - $gap_revenue_commission3)*$orp_commission_amount);
                                    $total_discount3 = $orp3 * $discount;
                                    $total_orp3 = $orp3 - $total_discount3;
                                    $lat_sale_price3 =$total_orp3*12;
