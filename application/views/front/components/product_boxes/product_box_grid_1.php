                                                        ...
                                                        { 
                                                            ...
                                                            { 
                                                                ...
                                                                <?php
                                                                    ...
                                                                    <a data-toggle="tooltip" producttype="related" title="<?php echo translate('_add_to_wishlist'); ?>"  pathaction="add" href="javascript:void(0);" class="to_wishlist  product<?php echo $product_id; ?>" productid="<?php echo $product_id; ?>" > <ion-icon name="heart-outline"></ion-icon></a>
                                                        <?php } }  ?>
                                                    </li>
                                                </ul>
