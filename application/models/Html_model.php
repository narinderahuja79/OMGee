...
class Html_model extends CI_Model
{
    ...
    function product_box1($product_data = array(), $type = '', $style = '',$other_data = array())
    {
        $this->load->view('front/components/product_boxes/product_box_'.$type.'_'.$style,$product_data,$other_data);
