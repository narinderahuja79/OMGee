 ...
 function checkKeyPressed(e) {
     if (e.keyCode == "13") {
         $(":focus").each(function() {
             if ($(this).is('textarea') || $(this).closest('.form-group').find('textarea').length > 0) {} else {
                 if ($(this).closest('.form-group').find('.bootstrap-tagsinput').length > 0) {} else {
                     e.preventDefault();
 ...
 function ajax_set_full(type, title, noty, form_id, id) {
     ...
     // console.log(type,title,noty,form_id,id);
